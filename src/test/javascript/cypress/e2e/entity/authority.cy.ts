...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '09bb97fb-882b-418e-ae80-26abba967bb8' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('d245cc2d-eb45-407e-a46f-e2f968061e0c');
      cy.get(`[data-cy="name"]`).should('have.value', 'd245cc2d-eb45-407e-a46f-e2f968061e0c');
